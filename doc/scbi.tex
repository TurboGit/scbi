...
\begin{description}
	...
	\item[\code{@on <discriminants> <module-reference>}] To set a module reference only if the running OS is matching the discriminants. The discriminants are separated with coma and can be the OS name (3 letters OS acronym supported) and the OS version. Use option \ddash{}stat to see all supported OS. This will overwrite previous definition for this module if any. All discriminants must match for the definition to take effect.
