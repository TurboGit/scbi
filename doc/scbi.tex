...
A list of discriminants are generated for each build. Those discriminants can be used in barrier (\see{planbarrier}). The discriminants are host and target specific and can be used to tune build plans.
