...
\begin{description}[style=nextline]
	...
	\begin{description}[font=\texttt]
		...
		\item[keep] \index{version!keep}To specify that the module sources should not be updated. So the \emph{setup, }\emph{configure}, \emph{build}, \emph{install} and \emph{wrapup} steps are not conducted and the module's will keep its current status as it was built last time.
