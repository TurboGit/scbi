...
\begin{description}[style=nextline]
	...
	\begin{description}
		...
		\item[DELETE | D] Remove \code{<VALUE>} from \code{<VARIABLE>} if it is present. This can be the single value in \code{<VARIABLE>} or one of the value in a list like for \code{PATH} or \code{LD\_LIBRARY\_PATH} variables.
	...
	\item[delete-from-var <VARIABLE> <VALUE>] short hand for \code{define-variable DELETE <VARIABLE> <VALUE>}.
