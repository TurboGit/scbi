...
\begin{description}
	...
	\item[\code{@alias <module-name1> <module-name2>}] To set an alias for modules in dependencies. If \code{<module-name1>} is not found while looking at dependencies then \code{<module-name2>} will be tried. This may be handy to propose a public alternative to some private plug-in.

    \begin{lstlisting}
	@alias private-module alternative-module
    \end{lstlisting}
