...
\begin{description}[font=\texttt]
	...
	\item[\ddash{}list-plan] List the final build plan that will be used. This is after loading main plan, inherithing from other plan \code{@load} and resolving the command line modules specification.
