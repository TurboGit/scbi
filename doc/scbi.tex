...
\label{scbi-module-final-step}
\index{hook!scbi-module-final-step}

After a successful build of a module or aggregate meta-module a specific hook named \code{scbi-module-final-step} is called.

\begin{description}
	\item[scbi-module-final-step] Called after a successful build. Can be used to update an application packaging for example.
	\begin{description}[font=\textit,style=standard]
...
\begin{lstlisting}
	function scbi-module-final-step()
	{
		local PREFIX=$1
		local TARGET=$2
		local VARIANT=$3
